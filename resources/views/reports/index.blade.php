            ...
            <div class="card shadow mb-4">
                ...
                <div class="card_body">
                    <form name="frmReport" action="{{ route('reports.search') }}" method="post" autocomplete="off">
                        ...
                        <div class="container">
                            <div class="row my-3">
                                <div class="col-md-3 col-7 mb-3 d-flex justify-content-center align-items-center font-weight-bolder text-monospace">
                                    Tgl Training
                                </div>
                                ...
                                <div class="col-md-1 col-2 d-flex justify-content-center align-items-center font-weight-bolder">
                                    -
                                </div>
                                <div class="col-md-3 col-5 d-flex justify-content-center align-items-center">
